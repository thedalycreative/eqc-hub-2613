...
const CLASSES = [
	...
	},
	{
		...
		links: [
			{ label: 'HTML Tags Cheat Sheet', href: 'references/html-tags.md' },
	...
	},
	{
		...
		links: [
			{ label: 'Folder Structure Cheat Sheet', href: 'references/folder-structure.md' },
			{ label: 'Wireframes Cheat Sheet', href: 'references/wireframes.md' },
	...
	},
	{
		...
		links: [{ label: 'Activity 4 — Model Answers', href: 'references/activity-4-ict-needs.md' }],
	},
	{
		...
		links: [
			{ label: 'Accessibility Cheat Sheet', href: 'references/accessibility.md' },
			{ label: 'QA Checklist', href: 'references/qa-checklist.md' },
	...
	},
	{
		...
		links: [
			...
			{ label: 'Flexbox Cheat Sheet', href: 'references/flexbox.md' },
	...
	},
	{
		...
		assignment: {
			...
			walkthrough: { label: 'Clone a Bootstrap site in 5 minutes', href: 'references/clone-a-site.md' },
		},
		...
		links: [
			...
			{ label: 'Bootstrap Cheat Sheet', href: 'references/bootstrap.md' },
	...
	},
	{
		...
		segments: [
			...
			},
			{
				...
				body: [
					...
					'Full walkthrough on the <a href="references/git.md" target="_blank">Git &amp; GitHub cheat sheet</a>',
				],
			},
			{
		...
		links: [
			{ label: 'Git & GitHub Cheat Sheet', href: 'references/git.md' },
			{ label: 'Class repo: S02-A01-BootstrapClone', href: 'https://github.com/thedalycreative/S02-A01-BootstrapClone' },
			{ label: 'Picsum — placeholder images', href: 'https://picsum.photos' },
			{ label: 'Homebrew (Mac)', href: 'https://brew.sh' },
			{ label: 'Bootstrap Cheat Sheet', href: 'references/bootstrap.md' },
		],
	},
	{
		num: 13, date: '2026-07-27', subject: 's2',
		title: 'Submit the clone + fix a client’s SEO', sub: 'Git wrap-up · submission · Katie’s metadata',
		focus: 'Three things: finish getting Git/GitHub working, submit the Bootstrap clone, and — kicking off Subject 1, Activity 2 — fix a real client’s broken SEO live in class.',
		topics: [
			'<strong>Git, finally sorted:</strong> on Windows, <strong>GitHub Desktop</strong> is the reliable path — Norton antivirus blocks the CLI/SSH route. Collaborators added by hand where the clone was denied',
			'2FA gotcha: the login wants the <strong>terminal-generated code</strong>, not the 6-digit authenticator one',
			'<a href="https://roadmap.sh" target="_blank" rel="noopener">roadmap.sh</a> — walked through as a developer learning map. Save it',
			'<strong>Submitting the clone:</strong> zip your local project folder and upload to Study Hub → <strong>Subject 2 → Activities → Build a Bootstrap Website</strong>. You upload the code, not a GitHub link',
			'<strong>Before you zip:</strong> delete the <code>README</code> and <code>.gitignore</code> files',
			'A README is <strong>optional / bonus</strong> — not a requirement. Want the extra credit? <a href="https://github.com/othneildrew/Best-README-Template" target="_blank" rel="noopener">Best-README-Template</a> is a good start',
			'Expect minor feedback in 1–2 weeks. That’s the normal process — don’t be discouraged',
			'<strong>Subject 1, Activity 2 — ICT Support:</strong> client "Katie" (a videographer) can’t be found on Google. The problem is SEO, and it lives in the <code>&lt;head&gt;</code> metadata',
			'The fix: rewrite <code>title</code>, <code>description</code>, <code>keywords</code> and <code>author</code> — the original had placeholder junk ("Bruce Wayne", "hi I am a keyword")',
			'<strong>Match the metadata to the visible page.</strong> The description echoing the homepage’s "capturing moments that last a lifetime" is a consistency signal search engines reward',
			'<code>author</code> is <em>your</em> company (the contractor), not the client. Copy the same metadata across every page — consistent is fine and recommended',
		],
		note: '<strong>Attendance:</strong> a few people marked the <em>wrong intake’s</em> sheet — double-check you’re on the 26.13 form.<br><br><strong>Coming Wednesday:</strong> Activity 2 Part 2 (a second client), and the Part 1 answers go up on the hub.',
		links: [
			{ label: 'Git & GitHub Cheat Sheet', href: 'references/git.md' },
			{ label: 'roadmap.sh — developer roadmaps', href: 'https://roadmap.sh' },
			{ label: 'GitHub Docs', href: 'https://docs.github.com' },
			{ label: 'Best-README-Template', href: 'https://github.com/othneildrew/Best-README-Template' },
			{ label: 'QA Checklist', href: 'references/qa-checklist.md' },
		],
	},
	{
		...
		links: [
			{ label: 'Activity 2 (Marvin) — Model Answers', href: 'references/activity-2-marvin.md' },
			{ label: 'HTML Tags Cheat Sheet', href: 'references/html-tags.md' },
			{ label: 'Bootstrap Cheat Sheet', href: 'references/bootstrap.md' },
			{ label: 'QA Checklist', href: 'references/qa-checklist.md' },
	...
	},
	{
		...
		assignment: {
			...
			walkthrough: { label: 'Build your own website — the walkthrough', href: 'references/build-your-own.md' },
		},
		links: [
			{ label: 'Folder Structure Cheat Sheet', href: 'references/folder-structure.md' },
			{ label: 'Excalidraw', href: 'https://excalidraw.com' },
	...
	},
	{
		...
		links: [{ label: 'QA Checklist', href: 'references/qa-checklist.md' }],
	},
	{
